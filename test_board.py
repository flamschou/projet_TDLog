...
def test_list_neighbors():
    ...
    assert len(board.list_neighbors(board.list[1])) == 3
    assert len(board.list_neighbors(board.list[2])) == 2
    assert len(board.list_neighbors(board.list[3])) == 4
    assert len(board.list_neighbors(board.list[4])) == 6
    assert len(board.list_neighbors(board.list[5])) == 4
    assert len(board.list_neighbors(board.list[6])) == 2
    assert len(board.list_neighbors(board.list[7])) == 3
    assert len(board.list_neighbors(board.list[8])) == 2
...
def test_neighbors():
    ...
    assert not board.neighbors(board.list[4], board.list[2])
...
def test_isdistance():
    ...
    assert board.isdistance(board.list[0], board.list[5], 2)
    assert board.isdistance(board.list[0], board.list[7], 3)
    assert board.isdistance(board.list[0], board.list[8], 3)
    assert not board.isdistance(board.list[0], board.list[2], 1)
    assert not board.isdistance(board.list[0], board.list[6], 2)
